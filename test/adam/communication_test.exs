defmodule Adam.CommunicationTest do
  ...
  describe "messages" do
    ...
    @valid_attrs %{provider: "some provider", receiver: "some receiver", sender: "some sender", type: "some type"}
    @update_attrs %{provider: "some updated provider", receiver: "some updated receiver", sender: "some updated sender", type: "some updated type"}
    @invalid_attrs %{provider: nil, receiver: nil, sender: nil, type: nil}
